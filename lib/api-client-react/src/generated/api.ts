...
export const getListBuildingsUrl = (params?: ListBuildingsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/buildings?${stringifiedParams}`
    : `/api/buildings`;
};
...
export const getListBuildingsQueryKey = (params?: ListBuildingsParams) => {
  return [`/api/buildings`, ...(params ? [params] : [])] as const;
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof listBuildings>>> = ({
    signal,
  }) => listBuildings(params, { signal, ...requestOptions });
...
export const getListElevatorsUrl = (params?: ListElevatorsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/elevators?${stringifiedParams}`
    : `/api/elevators`;
};

export const listElevators = async (
  params?: ListElevatorsParams,
  options?: RequestInit,
): Promise<Elevator[]> => {
...
export const getListElevatorsQueryKey = (params?: ListElevatorsParams) => {
  return [`/api/elevators`, ...(params ? [params] : [])] as const;
};

export const getListElevatorsQueryOptions = <
  TData = Awaited<ReturnType<typeof listElevators>>,
  TError = ErrorType<unknown>,
>(
  params?: ListElevatorsParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof listElevators>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof listElevators>>> = ({
    signal,
  }) => listElevators(params, { signal, ...requestOptions });
...
export type ListElevatorsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listElevators>>
>;
...
export function useListElevators<
  TData = Awaited<ReturnType<typeof listElevators>>,
  TError = ErrorType<unknown>,
>(
  params?: ListElevatorsParams,
...
export const createElevator = async (
  createElevatorBody: CreateElevatorBody,
  options?: RequestInit,
): Promise<Elevator> => {
  return customFetch<Elevator>(getCreateElevatorUrl(), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(createElevatorBody),
  });
};

export const getCreateElevatorMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type CreateElevatorMutationResult = NonNullable<
  Awaited<ReturnType<typeof createElevator>>
>;
...
export const getElevator = async (
  id: number,
  options?: RequestInit,
): Promise<Elevator> => {
...
export const getGetElevatorQueryKey = (id: number) => {
  return [`/api/elevators/${id}`] as const;
};

export const getGetElevatorQueryOptions = <
  TData = Awaited<ReturnType<typeof getElevator>>,
  TError = ErrorType<unknown>,
>(
  id: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getElevator>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getElevator>>> = ({
    signal,
  }) => getElevator(id, { signal, ...requestOptions });
...
export type GetElevatorQueryResult = NonNullable<
  Awaited<ReturnType<typeof getElevator>>
>;
...
export function useGetElevator<
  TData = Awaited<ReturnType<typeof getElevator>>,
  TError = ErrorType<unknown>,
>(
  id: number,
...
export const updateElevator = async (
  id: number,
  createElevatorBody: CreateElevatorBody,
  options?: RequestInit,
): Promise<Elevator> => {
...
export const getUpdateElevatorMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type UpdateElevatorMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateElevator>>
>;
...
export const deleteElevator = async (
  id: number,
  options?: RequestInit,
): Promise<void> => {
...
export const getDeleteElevatorMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type DeleteElevatorMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteElevator>>
>;
...
export const getAttentionInspections = async (
  options?: RequestInit,
): Promise<Inspection[]> => {
...
export const getGetAttentionInspectionsQueryKey = () => {
  return [`/api/dashboard/attention`] as const;
};

export const getGetAttentionInspectionsQueryOptions = <
  TData = Awaited<ReturnType<typeof getAttentionInspections>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getAttentionInspections>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetAttentionInspectionsQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getAttentionInspections>>
  > = ({ signal }) => getAttentionInspections({ signal, ...requestOptions });
...
export type GetAttentionInspectionsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getAttentionInspections>>
>;
...
export function useGetAttentionInspections<
  TData = Awaited<ReturnType<typeof getAttentionInspections>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
...
export const getOverdueByBuilding = async (
  options?: RequestInit,
): Promise<OverdueByBuildingItem[]> => {
...
export const getGetOverdueByBuildingQueryKey = () => {
  return [`/api/dashboard/overdue-by-building`] as const;
};

export const getGetOverdueByBuildingQueryOptions = <
  TData = Awaited<ReturnType<typeof getOverdueByBuilding>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getOverdueByBuilding>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getOverdueByBuilding>>
  > = ({ signal }) => getOverdueByBuilding({ signal, ...requestOptions });
...
export type GetOverdueByBuildingQueryResult = NonNullable<
  Awaited<ReturnType<typeof getOverdueByBuilding>>
>;
...
export function useGetOverdueByBuilding<
  TData = Awaited<ReturnType<typeof getOverdueByBuilding>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
...
export const getExportInspectionsUrl = (params?: ExportInspectionsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/export/inspections?${stringifiedParams}`
    : `/api/export/inspections`;
};

export const exportInspections = async (
  params?: ExportInspectionsParams,
  options?: RequestInit,
): Promise<Blob> => {
...
export const getExportInspectionsQueryKey = (
  params?: ExportInspectionsParams,
) => {
  return [`/api/export/inspections`, ...(params ? [params] : [])] as const;
};

export const getExportInspectionsQueryOptions = <
  TData = Awaited<ReturnType<typeof exportInspections>>,
  TError = ErrorType<unknown>,
>(
  params?: ExportInspectionsParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof exportInspections>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getExportInspectionsQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof exportInspections>>
  > = ({ signal }) => exportInspections(params, { signal, ...requestOptions });
...
export type ExportInspectionsQueryResult = NonNullable<
  Awaited<ReturnType<typeof exportInspections>>
>;
...
export function useExportInspections<
  TData = Awaited<ReturnType<typeof exportInspections>>,
  TError = ErrorType<unknown>,
>(
  params?: ExportInspectionsParams,
...
export const getExportElevatorsUrl = (params?: ExportElevatorsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/export/elevators?${stringifiedParams}`
    : `/api/export/elevators`;
};

export const exportElevators = async (
  params?: ExportElevatorsParams,
  options?: RequestInit,
): Promise<Blob> => {
...
export const getExportElevatorsQueryKey = (params?: ExportElevatorsParams) => {
  return [`/api/export/elevators`, ...(params ? [params] : [])] as const;
};

export const getExportElevatorsQueryOptions = <
  TData = Awaited<ReturnType<typeof exportElevators>>,
  TError = ErrorType<unknown>,
>(
  params?: ExportElevatorsParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof exportElevators>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof exportElevators>>> = ({
    signal,
  }) => exportElevators(params, { signal, ...requestOptions });
...
export type ExportElevatorsQueryResult = NonNullable<
  Awaited<ReturnType<typeof exportElevators>>
>;
...
export function useExportElevators<
  TData = Awaited<ReturnType<typeof exportElevators>>,
  TError = ErrorType<unknown>,
>(
  params?: ExportElevatorsParams,
