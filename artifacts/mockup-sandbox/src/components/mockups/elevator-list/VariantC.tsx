        ...
        <div className="flex-1 overflow-y-auto p-8">
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="rounded-lg border border-zinc-200 overflow-hidden shadow-sm bg-white">
              {/* Customer Header */}
              <div 
                className="grid grid-cols-[1fr_155px_85px_125px_125px_100px] bg-gradient-to-r from-zinc-900 to-zinc-800 border-t border-amber-500/30 cursor-pointer select-none"
              ...
              >
                <div className="flex items-center gap-3 px-4 py-3">
                  ...
                  <span className="text-xs font-medium bg-amber-500/20 text-amber-400 px-2 py-0.5 rounded-full ml-2">2</span>
                </div>
              ...
              {expandedCustomers['osb'] && (
                <div className="flex flex-col">
                  {/* Building */}
                  <div className="flex items-center gap-2 bg-zinc-50 border-l-[3px] border-zinc-500 pl-8 py-2.5 border-b border-zinc-100">
                  ...
                  {/* Elevator Row 1 */}
                  <div className="grid grid-cols-[1fr_155px_85px_125px_125px_100px] relative group hover:bg-amber-50/60 border-b border-zinc-100 transition-colors">
                    <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-amber-500 group-hover:bg-amber-400 transition-colors"></div>
                    ...
                    <div className="flex items-center px-4 py-2 border-l border-zinc-150">
                      <span className="text-sm font-medium text-zinc-800">Apr 16, 2028</span>
                    </div>
                    <div className="flex items-center px-4 py-2 border-l border-zinc-150">
                    ...
                    <div className="flex items-center justify-center px-4 py-2 border-l border-zinc-150">
                      <button className="p-1.5 text-zinc-400 hover:text-zinc-600 rounded-md border border-transparent hover:border-zinc-200 hover:bg-zinc-50 transition-colors">
                  ...
                  {/* Elevator Row 2 */}
                  <div className="grid grid-cols-[1fr_155px_85px_125px_125px_100px] relative group hover:bg-amber-50/60 transition-colors">
                    <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-amber-500 group-hover:bg-amber-400 transition-colors"></div>
                    <div className="flex flex-col justify-center px-4 py-2 pl-[4.5rem]">
            ...
            <div className="rounded-lg border border-zinc-200 overflow-hidden shadow-sm bg-white">
              ...
              >
                <div className="flex items-center gap-3 px-4 py-3">
                  ...
                  <span className="text-xs font-medium bg-amber-500/20 text-amber-400 px-2 py-0.5 rounded-full ml-2">3</span>
                </div>
                <div className="flex items-center px-4 py-3 border-l border-zinc-700">
                  <span className="text-[10px] font-semibold uppercase tracking-[0.12em] text-zinc-400">Status</span>
                </div>
              ...
              {expandedCustomers['cloud10'] && (
                <div className="flex flex-col">
                  ...
                  <div className="grid grid-cols-[1fr_155px_85px_125px_125px_100px] relative group hover:bg-amber-50/60 border-b border-zinc-100 transition-colors">
                    ...
                    <div className="flex items-center px-4 py-2 border-l border-zinc-150">
                      <span className="text-sm font-medium text-zinc-800">Oct 15, 2028</span>
                    </div>
                    <div className="flex items-center px-4 py-2 border-l border-zinc-150">
                      <span className="text-sm text-zinc-400">—</span>
                    </div>
                  ...
                  <div className="grid grid-cols-[1fr_155px_85px_125px_125px_100px] relative group hover:bg-amber-50/60 border-b border-zinc-100 transition-colors">
                    ...
                    <div className="flex items-center px-4 py-2 border-l border-zinc-150">
                      <span className="text-sm font-medium text-amber-600">Apr 02, 2024</span>
                    </div>
                    <div className="flex items-center px-4 py-2 border-l border-zinc-150">
                      <span className="text-sm text-zinc-400">—</span>
                    </div>
                  ...
                  <div className="grid grid-cols-[1fr_155px_85px_125px_125px_100px] relative group hover:bg-amber-50/60 transition-colors">
                    ...
                    <div className="flex items-center px-4 py-2 border-l border-zinc-150">
                      <span className="text-sm font-medium text-zinc-800">Dec 01, 2023</span>
                    </div>
                    <div className="flex items-center px-4 py-2 border-l border-zinc-150">
                      <span className="text-sm text-zinc-400">—</span>
                    </div>
