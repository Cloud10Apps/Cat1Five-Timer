...
export default function RefinedALogin() {
      ...
      <div className="hidden md:flex md:w-1/2 bg-zinc-950 text-zinc-50 flex-col justify-between p-12 lg:p-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg mt-12 mb-auto md:my-auto">
          <h1 className="text-5xl lg:text-6xl font-bold tracking-tight mb-6 text-zinc-50 leading-[1.05]">
            Track compliance. <br />
            <div className="text-amber-500 mt-2">Stay ahead of inspections.</div>
          </h1>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <div className="mt-1 rounded-full bg-amber-500/15 p-2 text-amber-400">
        ...
        <div className="relative z-10 text-sm text-zinc-500">
          © {new Date().getFullYear()} ElevatorInspect Pro Inc. All rights reserved.
        </div>
      </div>

      {/* Right Panel - Login Form */}
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-zinc-50 relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="email" className="uppercase text-xs tracking-widest font-semibold text-zinc-500">Email address</Label>
                <Input 
                  id="email" 
                  type="email" 
                  ...
                  required
                  className="h-11 border-zinc-300 bg-white focus-visible:ring-amber-500"
                />
              </div>
              
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <Label htmlFor="password" className="uppercase text-xs tracking-widest font-semibold text-zinc-500">Password</Label>
